...
router.get('/:userId/events', checkAuth, EventController.get_all_events);
...
router.put("/:userId/events/:eventId/edit", checkAuth, EventController.event_edit);
//delete method about delete event
router.delete("/:userId/events/:eventId/delete", checkAuth, EventController.event_delete);
