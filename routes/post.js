...
router.get("/home/:id", checkAuth, PostController.home);
//get method about show single post
router.get("/home/single/:postId", checkAuth, PostController.view_post);
...
router.get("/home/like/:postId", checkAuth, PostController.like);
//get method about share post
router.get("/home/single/share", checkAuth, PostController.share);
